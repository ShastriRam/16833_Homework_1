...
def f(x):
    return 1 if x > .9 else 0 # This gives an image where it is 1 if it is free space and 0 
    #                          # if you can't be there.  
    #return 1 if x > .6 and x < .7 else 0
f = np.vectorize(f)  
...
class MapReader:
    ...
    def __init__(self, src_path_map):
        ...
        self._occupancy_map = f(self._occupancy_map)
